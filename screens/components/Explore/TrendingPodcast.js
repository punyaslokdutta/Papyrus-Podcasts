  ...
  async function retrievePodcastDoc(podcastID)
  {
    ...
    return (
      ...
      <View style={{paddingHorizontal:10,height:height*2/15,borderColor:'black',height:height*10/40}}>
        <Text style={{height:height/15,fontFamily:'Proxima-Nova-Bold',fontSize:20}}> {podcastName}{"   "} </Text>
      <Text style={{height:height/17,fontFamily:'Proxima-Nova-Regular',color:'gray',paddingBottom:0,fontSize:12}}> {item.podcastDescription}</Text>
        </View>
