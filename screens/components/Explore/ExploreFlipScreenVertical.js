...
class ExploreFlipScreenVertical extends React.Component {
  ...
  retrieveData = async () => {
    ...
    try {
      ...
      console.log("Error in ExploreFlipScreenVertical in retrieveData: ",error);
    }
    finally {
  ...
  export default connect(mapStateToProps,mapDispatchToProps)(withFirebaseHOC(ExploreFlipScreenVertical))
