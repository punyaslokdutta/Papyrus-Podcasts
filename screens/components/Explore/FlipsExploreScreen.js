...
class FlipsExploreScreen extends React.Component {
  ...
  retrieveData = async () => {
    ...
    try {
      ...
      console.log("Error in FlipsExploreScreen in retrieveData: ",error);
    }
    finally {
  ...
  export default connect(mapStateToProps,mapDispatchToProps)(withFirebaseHOC(FlipsExploreScreen))
