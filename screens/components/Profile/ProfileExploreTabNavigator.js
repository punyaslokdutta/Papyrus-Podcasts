...
import UserBookPodcast from '../Explore/UserBookPodcast';
import UserChapterPodcast from '../Explore/UserChapterPodcast';
...
import CustomProfileUserHeader from './CustomProfileUserHeader';
...
const NAV_BAR_HEIGHT = HEADER_HEIGHT - STATUS_BAR_HEIGHT;
  ...
  const ProfileExploreTabNavigator = createMaterialTopTabNavigator(
    {
    ...
    {tabBarOptions:{
      ...
      labelStyle: {
       ...
       navigationOptions:
       {
         tabBarVisible: true,
         //headerVisible: true,
           header: props => <CustomProfileUserHeader {...props} />, 
         
       }
      }
  )
  
  export default ProfileExploreTabNavigator;
