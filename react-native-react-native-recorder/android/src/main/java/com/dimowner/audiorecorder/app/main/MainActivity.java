...
public class MainActivity extends ReactActivity implements MainContract.View, View.OnClickListener {
...
// TODO: Stop infinite loop when pause WAV recording
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //arApplication=new ARApplication();
        //getInjector().provideMainPresenter();
